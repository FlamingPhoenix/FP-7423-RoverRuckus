...
@Autonomous(name="Oxford Red Depot", group="none") //used to be called Red Gold, messed up Gold/Silver
...
//        if (opModeIsActive()) {
                            ...
                            if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                                ...
                                if (center_Gold < 300f) {   // here 300 can change to other numbers, perhaps 400 ?
                                    ...
                                    if (currentTime < (secondHitTime - 500)) { // this is first time hit
                                        ...
                                        drivetrain.Strafe(0.4f, 35, Direction.RIGHT);
                                        drivetrain.StopAll();
                                        sleep(500);
        ...
        VuforiaTrackable backTarget = rover.get(3);  // front was 2(red planet), image should be red alliance
