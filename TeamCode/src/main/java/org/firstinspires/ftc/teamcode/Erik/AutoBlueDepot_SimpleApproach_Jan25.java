...
@Disabled
@Autonomous(name="BlueDepot_Test_Simple_Diagonal_Scan_backup", group="none")
public class AutoBlueDepot_SimpleApproach_Jan25 extends AutoBase {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        //setRobotStartingAngle(); add back later
