...
public class ExperimentVuforiaDriveUntilImageVisible extends LinearOpMode {
    ...
    DcMotor bl;
    DcMotor br;
    DriveTrain drivetrain;  // why not ErikDriveTrain vs DriveTrain type ? just cuz
    MyBoschIMU imu;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drivetrain.DriveUntilImageVisible(0.13F, Direction.FORWARD, 50.8F, backTarget, this);
