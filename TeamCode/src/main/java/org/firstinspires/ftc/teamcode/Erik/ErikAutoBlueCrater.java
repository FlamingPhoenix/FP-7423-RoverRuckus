...
@Autonomous(name="Oxford Blue Crater", group="none") // used to be called Blue Gold, messed up gold and silver
//@TeleOp(name="Erik Auto Subclass", group="none")

public class ErikAutoBlueCrater extends LinearOpMode {
...
//        if (opModeIsActive()) {
                                ...
                                if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                                    ...
                                    if (center_Gold < 300f) {   // here 300 can change to other numbers, perhaps 400 ?
                                        ...
                                        if (currentTime < (secondHitTime - 2000)) { // this is first time hit
                                            ...
                                            drivetrain.StopAll();
                                            drivetrain.Strafe(0.3f, 18, Direction.LEFT);
                                            drivetrain.StopAll();
                                            //tfod.deactivate();
                                            //tfod.shutdown();
                                            ...
                                            drivetrain.StopAll();
                                            drivetrain.Strafe(0.3f, 6, Direction.LEFT);
                                            //tfod.deactivate();
                                            //tfod.shutdown();
                                            ...
                                            drivetrain.StopAll();
                                            drivetrain.Strafe(0.3f, 12, Direction.LEFT);
                                            //tfod.deactivate();
                                            //tfod.shutdown();
        ...
        VuforiaTrackable backTarget = rover.get(0); // picture is blue alliance
        backTarget.setName("blue");
