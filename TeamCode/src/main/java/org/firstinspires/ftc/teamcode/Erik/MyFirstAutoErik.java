...
import org.firstinspires.ftc.teamcode.Erik.DriveTrainErik;

/**
 * Created by Steve on 7/22/2018.
 */

@Autonomous(name="Erik First Auto", group="none")
public class MyFirstAutoErik extends LinearOpMode {
    DcMotor fl;
    DcMotor fr;
    DcMotor bl;
    DcMotor br;
    DriveTrainErik drivetrain;
    BNO055IMU imu;
    ...
    public void initialize() {
        ...
        drivetrain = new DriveTrainErik(fl, fr, bl, br);
